...
const stats = [
  { val: "500+", label: "شركة تستخدم ترميز OS" },
  ...
  return (
    <PublicLayout>
      <div className="pt-24">
        ...
        <section className="py-24 bg-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-gray-500 leading-relaxed max-w-2xl mx-auto">
              بدأت فكرة ترميز OS من تجربة شخصية — رأينا كيف يُضيع أصحاب الفعاليات ساعات طويلة في إدارة الحجوزات
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {stats.map((s) => (
                <div key={s.label} className="text-center">
                  <p className="text-4xl font-black text-brand-500 mb-2">{s.val}</p>
        ...
        {/* CTA */}
        <section className="py-20 bg-brand-500 text-center">
          <div className="max-w-2xl mx-auto px-6">
            <h2 className="text-3xl font-black text-white mb-4">انضم إلى عائلة ترميز OS</h2>
            <p className="text-blue-200 mb-8">نحن هنا لمساعدتك في بناء عمل ناجح</p>
            <Link to="/register" className="inline-block bg-white text-brand-500 px-8 py-4 rounded-xl font-bold hover:bg-gray-100 transition-colors">
              ابدأ مجاناً
            </Link>
          </div>
        </section>
