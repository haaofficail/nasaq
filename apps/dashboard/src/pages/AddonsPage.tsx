          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {addons.map((addon: any) => (
                <tr key={addon.id} className="border-b border-gray-50 hover:bg-[#f8fafc]/50 transition-colors">
                  ...
                  <td className="py-[6px] px-[10px] font-semibold tabular-nums text-gray-900">
