  ...
  return (
    <PublicLayout>
      <div className="pt-24">
              ...
              <div className={`flex flex-col md:flex-row items-center gap-12 ${i % 2 === 1 ? "md:flex-row-reverse" : ""}`}>
                ...
                <div className="flex-1">
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8 h-64 flex items-center justify-center">
                    <f.icon className="w-24 h-24 text-brand-500 opacity-20" />
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* CTA */}
        <section className="py-24 bg-brand-500 text-center">
          <div className="max-w-2xl mx-auto px-6">
            ...
            <Link
              to="/register"
              className="inline-block bg-white text-brand-500 px-10 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transition-colors"
            >
              ابدأ مجاناً الآن
            </Link>
          </div>
