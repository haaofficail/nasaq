        ...
        <div key={i} className="px-5 py-4 animate-pulse">
          <div className="flex items-start gap-3">
            ...
            <div className="shrink-0">
              <div className="h-7 bg-[#f1f5f9] rounded-lg w-20" />
            </div>
          </div>
        </div>
      ))}
    ...
    <div className="px-5 py-3 border-b border-[#eef2f6]">
      <div className="relative">
        ...
        <input
          ...
          className="w-full border border-[#eef2f6] rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-300/30 focus:border-brand-500 pr-9"
        />
      </div>
    </div>
  );
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={refetchAll}
            className="w-9 h-9 flex items-center justify-center rounded-xl border border-[#eef2f6] hover:bg-[#f8fafc] text-gray-500"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className={clsx("bg-white rounded-2xl border p-4", expiringCount > 0 ? "border-amber-200" : "border-[#eef2f6]")}>
          <div className={clsx("w-9 h-9 rounded-xl flex items-center justify-center mb-3", expiringCount > 0 ? "bg-amber-50" : "bg-[#f8fafc]")}>
        ...
        <div className={clsx("bg-white rounded-2xl border p-4", lowStock.length > 0 ? "border-red-200" : "border-[#eef2f6]")}>
          <div className={clsx("w-9 h-9 rounded-xl flex items-center justify-center mb-3", lowStock.length > 0 ? "bg-red-50" : "bg-[#f8fafc]")}>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="shrink-0">
                          <select
                            ...
                            className="text-xs border border-[#eef2f6] rounded-lg px-2 py-1 bg-white focus:outline-none focus:ring-1 focus:ring-brand-300"
                          >
        ...
        <Modal title="استلام شحنة جديدة" onClose={() => setReceiveModal(false)}>
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              <button onClick={() => setReceiveModal(false)} className="flex-1 border border-[#eef2f6] text-gray-600 rounded-xl py-2.5 text-sm font-medium hover:bg-[#f8fafc]">
                إلغاء
              </button>
              <button
                onClick={saveReceive}
      ...
      {consumeModal && (
        <Modal title="سحب من المخزون (FEFO)" onClose={() => setConsumeModal(false)}>
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              <button onClick={() => setConsumeModal(false)} className="flex-1 border border-[#eef2f6] text-gray-600 rounded-xl py-2.5 text-sm font-medium hover:bg-[#f8fafc]">
                إلغاء
              </button>
              <button
                onClick={saveConsume}
...
const inputCls = "w-full border border-[#eef2f6] rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-300";
