    ...
    <div style={{ background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 16, padding: "22px 24px" }}>
      ...
      {status === "error" && (
        <p style={{ fontSize: 12, color: "#dc2626", marginBottom: 12 }}>
          حدث خطأ أو تجاوزت الحد المسموح — تواصل مع privacy@tarmizos.com
        </p>
      )}
