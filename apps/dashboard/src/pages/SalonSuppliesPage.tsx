      ...
      <div className="bg-white rounded-2xl w-full max-w-md shadow-xl">
        ...
        <div className="p-5 space-y-4">
          <div>
            ...
            <input
              className="w-full border border-[#eef2f6] rounded-xl px-3 py-2 text-sm"
              value={form.name}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <select
                className="w-full border border-[#eef2f6] rounded-xl px-3 py-2 text-sm bg-white"
                value={form.category}
        ...
        <div className="px-5 pb-5 flex gap-2 justify-end">
          <button onClick={onClose} className="px-4 py-2 rounded-xl border border-[#eef2f6] text-sm text-gray-600 hover:bg-[#f8fafc]">
            إلغاء
          </button>
          <button
            onClick={handleSave}
    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-end sm:items-center justify-center p-4">
      <div className="bg-white rounded-2xl w-full max-w-sm shadow-xl">
        ...
        <div className="p-5 space-y-4">
          ...
          {/* Add / Remove toggle */}
          <div className="flex rounded-2xl overflow-hidden border border-[#eef2f6]">
            <button
              className={clsx("flex-1 py-2 text-sm font-medium flex items-center justify-center gap-1",
                type === "add" ? "bg-green-500 text-white" : "text-gray-500 hover:bg-[#f8fafc]")}
            ...
            <button
              className={clsx("flex-1 py-2 text-sm font-medium flex items-center justify-center gap-1",
                type === "remove" ? "bg-red-500 text-white" : "text-gray-500 hover:bg-[#f8fafc]")}
      ...
      <div className="flex gap-2 flex-wrap">
        <button
          ...
          className={clsx("px-3 py-1.5 rounded-xl text-xs font-medium border",
            !filterCategory ? "bg-brand-500 text-white border-brand-500" : "border-[#eef2f6] text-gray-600 hover:bg-[#f8fafc]")}
        >
          الكل
        </button>
        {Object.entries(CATEGORIES).map(([v, l]) => (
          <button
            ...
            className={clsx("px-3 py-1.5 rounded-xl text-xs font-medium border",
              filterCategory === v ? "bg-brand-500 text-white border-brand-500" : "border-[#eef2f6] text-gray-600 hover:bg-[#f8fafc]")}
          >
            {l}
          </button>
        ))}
            ...
            <div key={cat}>
              ...
              <div className="space-y-2">
                {items.map(supply => {
                  ...
                  return (
                    <div key={supply.id} className="bg-white rounded-2xl border border-[#eef2f6] overflow-hidden">
                      <div className="flex items-center gap-3 px-4 py-3">
                        {/* Quantity indicator */}
                        <div className={clsx(
                          "w-9 h-9 rounded-[10px] flex items-center justify-center text-sm font-bold shrink-0",
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          ...
                          <button
                            ...
                            className="w-8 h-8 rounded-lg border border-[#eef2f6] text-gray-500 flex items-center justify-center hover:bg-[#f8fafc]"
                            title="تعديل"
                          >
                          ...
                          <button
                            ...
                            className="w-8 h-8 rounded-lg border border-[#eef2f6] text-gray-400 flex items-center justify-center hover:bg-[#f8fafc]"
                            title="السجل"
                          >
