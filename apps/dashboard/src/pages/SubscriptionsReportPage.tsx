                    ...
                    {rows.map((r: any, i: number) => {
                      ...
                      return (
                        <tr key={i} className="border-b border-gray-50 last:border-0 hover:bg-gray-50/40 transition-colors">
                          ...
                          <td className="px-4 py-3 text-xs text-gray-400" dir="ltr">{r.phone || "—"}</td>
                          <td className="px-4 py-3 text-gray-700">{r.subscriptionName || "—"}</td>
                          <td className="px-4 py-3 tabular-nums font-bold text-emerald-700">{fmt(r.price)} ر.س</td>
