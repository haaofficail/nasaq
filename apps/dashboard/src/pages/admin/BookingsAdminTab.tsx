            ...
            <tbody>
              {rows.map((r: any) => (
                <tr key={r.id} className="border-b border-gray-50 hover:bg-gray-50 last:border-0">
                  ...
                  <td className="px-4 py-3 text-sm text-gray-900 font-mono" dir="ltr">{r.bookingNumber}</td>
                  ...
                  <td className="px-4 py-3 text-xs text-gray-500 hidden md:table-cell">{r.source ?? "—"}</td>
                </tr>
              ))}
            </tbody>
          </table>
