...
export const adminApi = {
  ...
  orgs: (params?: { q?: string; status?: string; plan?: string; page?: number; limit?: number }) => {
    const q = new URLSearchParams();
  ...
  auditLog: (page?: number) => api.get<{ data: any[]; pagination: any }>(`/admin/audit-log${page ? `?page=${page}` : ""}`),
