...
const SECTIONS: Section[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: "بعد إنشاء العقد، اذهب إلى ejar.sa ووثّق العقد. عد إلى نسق وأدخل رقم عقد إيجار في بطاقة العقد. هذا إلزامي قانونياً.",
        link: "/property/contracts",
      },
    ],
    tips: [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: "وثّق العقد على ejar.sa ثم أدخل رقم عقد إيجار في نسق. بادج إيجار يتحول من أحمر إلى أخضر. العقد الموثق = سند تنفيذي قانوني.",
        link: "/property/contracts",
      },
      {
        step: "3",
  ...
  },
  {
    ...
    steps: [
      {
        ...
        desc: "كل عقد إيجار يجب توثيقه في ejar.sa. الغرامة على عدم التوثيق قانونية. في نسق: اضغط على بادج إيجار الأحمر في العقد لتسجيل رقم التوثيق.",
    ...
    tips: [
      ...
      "الفواتير التجارية (VAT 15%) يجب أن تحتوي QR ZATCA — يُنشأ تلقائياً في نسق.",
    ],
  },
  {
    id: "reports",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: "المستأجر يدفع مباشرة عبر البوابة (مدى / بطاقة / محفظة). المبلغ يُسجّل تلقائياً في حسابه في نسق.",
        link: "/property/portal",
      },
      {
        step: "4",
...
const REGULATIONS = [
  ...
  },
  {
    ...
    desc: "العقارات التجارية: فاتورة بـ QR إلزامية + VAT 15%. يُنشأ تلقائياً في نسق.",
  ...
  return (
    <div className="p-6 space-y-8 max-w-3xl mx-auto" dir="rtl">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-brand-700 mt-1 leading-relaxed">
              أي إجراء في نسق لا يتجاوز 3 ضغطات. بعد كل خطوة — النظام يقترح الخطوة التالية تلقائياً.
      ...
      <p className="text-xs text-gray-400 text-center pb-4">
        نسق — نظام إدارة العقارات الذكي — يخدم المالك المباشر ومكاتب إدارة الأملاك
      </p>
    </div>
  );
}
