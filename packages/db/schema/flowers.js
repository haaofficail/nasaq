import { pgTable, pgEnum, text, timestamp, boolean, uuid, integer, numeric, uniqueIndex, index, } from "drizzle-orm/pg-core";
...
export const flowerVariants = pgTable("flower_variants", {
    ...
    uniqueIndex("flower_variants_identity_idx").on(table.flowerType, table.color, table.origin, table.grade, table.size, table.bloomStage),
