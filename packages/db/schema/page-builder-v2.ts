...
// ============================================================
// PAGE BUILDER V2 — صفحات منشئ المحتوى الجديد
//
// مستقلة تماماً عن v1 (site_pages) — لا تتقاطع أبداً.
// Puck data format: { content: [...], root: { props: {...} } }
// ============================================================

// ── Status type ──────────────────────────────────────────────
// 'draft'     = لم تُنشر
// 'published' = منشورة وتظهر للزوار
// 'archived'  = مؤرشفة (لا تحذف)
type PageStatus = "draft" | "published" | "archived";

// ── Change type (للإصدارات) ──────────────────────────────────
// 'auto_save'    = حفظ تلقائي كل 30 ثانية
// 'manual_save'  = المستخدم ضغط "حفظ"
// 'publish'      = نشر — يُنشئ نسخة مؤشرة
// 'restore'      = استعادة نسخة سابقة
