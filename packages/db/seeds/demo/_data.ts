...
export const ALL_ORGS: OrgConfig[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    hasPos: true,
    categories: ["باقات الورود","تنسيقات الأعراس","الهدايا والصناديق","النباتات الطبيعية","تنسيقات المناسبات","الديكور الزهري"],
    services: [
      { category: "باقات الورود",       name: "بوكيه ورد أحمر رومانسي 24 وردة",                  price: 280,  minPrice: 200,  duration: 30  },
      { category: "باقات الورود",       name: "بوكيه ورد مختلط موسمي",                            price: 180,  minPrice: 120,  duration: 25  },
      { category: "تنسيقات الأعراس",   name: "تنسيق كوش مدخل زفاف",                              price: 3500, minPrice: 2800, duration: 240 },
      { category: "تنسيقات الأعراس",   name: "بوكيه عروس مع تاج ورد طبيعي",                      price: 650,  minPrice: 500,  duration: 60  },
      { category: "تنسيقات الأعراس",   name: "تنسيق طاولات حفل زفاف (لكل طاولة)",                price: 450,  minPrice: 350,  duration: 45  },
      { category: "الهدايا والصناديق", name: "صندوق هدية فاخر مع أوركيد",                        price: 480,  minPrice: 380,  duration: 20  },
      { category: "الهدايا والصناديق", name: "صندوق ورد دائم Preserved Flowers",                  price: 580,  minPrice: 450,  duration: 20  },
      { category: "النباتات الطبيعية", name: "نبات فيكس داخلي مع وعاء خزفي",                      price: 220,  minPrice: 180,  duration: 15  },
      { category: "النباتات الطبيعية", name: "نبات سكولنت مجموعة 3 قطع",                          price: 150,  minPrice: 120,  duration: 15  },
      { category: "تنسيقات المناسبات", name: "تنسيق طاولة مؤتمر أو حفل",                          price: 320,  minPrice: 250,  duration: 30  },
      { category: "تنسيقات المناسبات", name: "زينة افتتاح محل تجاري",                              price: 1800, minPrice: 1400, duration: 180 },
      { category: "الديكور الزهري",     name: "لوحة ورد جاف للجدار",                              price: 380,  minPrice: 300,  duration: 45  },
    ],
  },
