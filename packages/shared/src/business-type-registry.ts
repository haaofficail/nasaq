...
//
// المصدر الوحيد للحقيقة لكل نوع نشاط في ترميز OS.
...
const REGISTRY: BusinessConfig[] = [
...

  {
    ...
    terminology: {
      ...
      loginTitle: "مرحباً بعودتك",
      newItem: "منتج جديد",
      onboardingAddItems: "أضف منتجات المخبز",
...

  {
    ...
    terminology: {
      ...
      onboardingAddStaffDesc: "يتمكن الموظف من تسجيل الدخول وإدارة الحجوزات",
      onboardingFirstBooking: "استقبل أول حجز",
      onboardingFirstBookingDesc: "أنشئ حجزاً يدوياً أو شارك رابط الطلب مع عملائك",
      searchBookingPlaceholder: "بحث برقم الحجز أو اسم العميل...",
      kpiTodayBookings: "حجوزات اليوم",
      kpiTodayBookingUnit: "حجز",
      topItemsTitle: "أبرز الأصناف",
...

  {
    ...
    terminology: {
      items: "المنتجات والتنسيقات", item: "منتج", addItem: "إضافة منتج", editItem: "تعديل المنتج",
      deleteItem: "حذف المنتج", itemPrice: "سعر المنتج", itemDuration: "وقت التحضير",
      itemEmpty: "لا توجد منتجات بعد", categories: "التصنيفات", category: "تصنيف",
      addCategory: "إضافة تصنيف", catalog: "منتجات المتجر الإلكتروني", catalogEmpty: "أضف منتجات متجرك",
      topItems: "أكثر المنتجات مبيعاً",
      booking: "طلب", bookings: "الطلبات", addBooking: "طلب جديد", newBooking: "طلب جديد",
      bookingEmpty: "لا توجد طلبات بعد",
      client: "عميل", clients: "العملاء", newClient: "عميل جديد", clientEmpty: "لا يوجد عملاء بعد",
    ...
    sidebar: [
      ...
      { key: "customers",        label: "العملاء",          href: "/dashboard/customers",        iconKey: "Users",      group: "العمليات" },
      { key: "catalog",          label: "التنسيقات والباقات", href: "/dashboard/catalog",          iconKey: "Layers",     group: "الإدارة" },
      { key: "flower_inventory", label: "مخزون الورد",     href: "/dashboard/flower-inventory", iconKey: "Box",        group: "التخصصي" },
      { key: "flower_master",    label: "أنواع الورد وأسعاره", href: "/dashboard/flower-master", iconKey: "Leaf",       group: "التخصصي" },
      { key: "arrangements",     label: "الباقات الجاهزة", href: "/dashboard/arrangements",     iconKey: "Flower2",    group: "التخصصي" },
      { key: "finance",          label: "المالية",           href: "/dashboard/finance",          iconKey: "Wallet",     group: "الإدارة" },
      { key: "reports",          label: "التقارير",          href: "/dashboard/reports",          iconKey: "BarChart3",  group: "النمو" },
      SETTINGS_ITEM,
    ],
...

  {
    ...
    terminology: {
      ...
      onboardingAddDataDesc: "الاسم والمدينة يظهران للعملاء في صفحة الطلب",
      onboardingAddStaff: "أضف موظفاً لفريقك",
      onboardingAddStaffDesc: "يتمكن الموظف من تسجيل الدخول وإدارة العقود",
      onboardingFirstBooking: "استقبل أول حجز",
...

  {
    ...
    terminology: {
      ...
      loginTitle: "مرحباً بعودتك",
      newItem: "باقة جديدة",
      onboardingAddItems: "أضف باقات الفعاليات",
...

  {
    ...
    terminology: {
      ...
      onboardingAddStaffDesc: "يتمكن الموظف من تسجيل الدخول وإدارة الجلسات",
      onboardingFirstBooking: "استقبل أول جلسة",
      onboardingFirstBookingDesc: "أنشئ جلسةً يدوياً أو شارك رابط الحجز مع العملاء",
      searchBookingPlaceholder: "بحث برقم الجلسة أو اسم العميل...",
      kpiTodayBookings: "جلسات اليوم",
      kpiTodayBookingUnit: "جلسة",
      topItemsTitle: "أبرز الخدمات",
      recentBookingsTitle: "آخر الجلسات",
    },
    sidebar: [
      HOME_ITEM,
...

  {
    ...
    terminology: {
      ...
      onboardingAddStaffDesc: "يتمكن الموظف من تسجيل الدخول وإدارة طلبات الصيانة",
      onboardingFirstBooking: "استقبل أول طلب",
...

  {
    ...
    terminology: {
      ...
      onboardingAddDataDesc: "الاسم والمدينة يظهران للعملاء في صفحة الطلب",
      onboardingAddStaff: "أضف فنياً لفريقك",
      onboardingAddStaffDesc: "يتمكن الموظف من تسجيل الدخول وإدارة طلبات العمل",
      onboardingFirstBooking: "استقبل أول طلب",
...

  {
    ...
    terminology: {
      ...
      onboardingAddDataDesc: "الاسم والمدينة يظهران للعملاء في صفحة الطلب",
      onboardingAddStaff: "أضف موظفاً لفريقك",
      onboardingAddStaffDesc: "يتمكن الموظف من تسجيل الدخول وإدارة المشاريع",
      onboardingFirstBooking: "استقبل أول مشروع",
      onboardingFirstBookingDesc: "أنشئ مشروعاً يدوياً أو تواصل مع العميل",
      searchBookingPlaceholder: "بحث برقم المشروع أو اسم العميل...",
      kpiTodayBookings: "مشاريع اليوم",
      kpiTodayBookingUnit: "مشروع",
      topItemsTitle: "أبرز الخدمات",
      recentBookingsTitle: "آخر المشاريع",
    },
    sidebar: [
      HOME_ITEM,
...

  {
    ...
    terminology: {
      ...
      onboardingAddStaffDesc: "يتمكن الموظف من تسجيل الدخول وإدارة المشاريع",
      onboardingFirstBooking: "استقبل أول مشروع",
      onboardingFirstBookingDesc: "أنشئ مشروعاً يدوياً أو شارك رابط المشاريع مع العملاء",
      searchBookingPlaceholder: "بحث برقم المشروع أو اسم العميل...",
      kpiTodayBookings: "مشاريع اليوم",
      kpiTodayBookingUnit: "مشروع",
      topItemsTitle: "أبرز الحلول",
      recentBookingsTitle: "آخر المشاريع",
    },
    sidebar: [
      HOME_ITEM,
...

  {
    ...
    terminology: {
      ...
      onboardingAddStaffDesc: "يتمكن المعلم من تسجيل الدخول وإدارة التسجيلات",
